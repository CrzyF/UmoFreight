...
const LiveStream = ({ navigation }) => {
  ...
  return (
    ...
    <Camera
      ...
      <TouchableOpacity onPress={handleCaptureImage} disabled={!location}>
        <View style={[styles.iconLayout, styles.circle, { backgroundColor: !location ? 'gray' : 'white' }]} />
      </TouchableOpacity>


      <TouchableOpacity style={[styles.groupIcon, styles.iconLayout]} onPress={flipCamera}>
      ...
      <TouchableOpacity style={[styles.vectorIcon1, styles.iconLayout]} onPress={toggleFlashMode}>
