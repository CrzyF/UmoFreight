...
const ScanDetails = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.scanDetails}>
            ...
            <TouchableOpacity style={[styles.rectangleIcon, styles.rectangleIconLayout]} onPress={() => navigation.push('Scanner')}>
            ...
            <Text style={[styles.of281, styles.of281Typo]}>1 of 28</Text>
            {/* <Image
