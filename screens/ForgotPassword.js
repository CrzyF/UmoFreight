...
const ForgotPassword = ({navigation}) => {
  return (
    <View style={styles.login}>
      ...
      <TouchableOpacity onPress={() => navigation.push('ResetPassword')} style={[styles.login1, styles.loginLayout1]}>
      ...
      <Text style={[styles.welcomeBack, styles.resetClr]}>Forgot Password?</Text>
      <Text style={[styles.pleaseLoginTo, styles.signupButtonPosition]}>
      Have you forgotten your password? Please enter the email address you used to register. An email will be sent with a confirmation link.
      </Text>
